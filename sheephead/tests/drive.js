 ...
 *
 * THIS IS THE STABLE GAME. It shares no code with sheephead-multiplayer/ — the
 * fork exists so this one cannot regress while multiplayer is built, and CI
 * refuses any branch that changes both. What it does share is a stylesheet
 * lineage, which is why the contrast bug that audit found in three multiplayer
 * games was sitting here too, at the same 1.41:1, in the game people actually
 * play. A file like this is what lets the shared audit see it.
 *
