...
(function (global) {
  ...
  var DEFAULTS = { pace: 450, points: 500, skin: 'traditional', autofocus: true };
  var settings = { pace: 450, points: 500, skin: 'traditional', autofocus: true };
  ...
  /* The dialog and the start screen hold the same settings between them, so both
   * are written from `settings` and both write back to it. Two forms that
   * disagree about the current pace is worse than one form. */
