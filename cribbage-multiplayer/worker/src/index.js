/* Cribbage - the Cloudflare edge of the room.
 *
...
export class CribbageRoom {
  ...
  ensureRoom(config) {
    ...
    this.room = SH.Room.create({
       ...
       * length of time to spend choosing what to throw to the crib when the
       * hand has to be read aloud first, and a client that is still answering
       * its pings has not stopped responding, whatever it is doing with its
       * turn.
       *
 ...
 * nobody can play, so these are the ordinary rules of euchre rather than
