/* Cribbage - a room, with nothing platform-specific in it.
 *
...
(function (global) {
  ...
  function createRoom(opts) {
    ...
    function action(connId, msg) {
       ...
       *
       * THE CONDITION ASKS THE ENGINE, and does not name a phase. This file was
       * forked from a game whose finished-hand phase is called 'handOver'; that
       * name arrived here inside this guard, where it is true at every moment of
       * a cribbage hand — so every deal sent over the wire was swallowed and
       * answered with a re-sent view. Online play could not get past hand one
