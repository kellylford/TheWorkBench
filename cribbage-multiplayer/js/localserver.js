/* Cribbage - an authoritative server that happens to be in this tab.
 *
...
(function (global) {
  ...
  function create(opts) {
     ...
     *
     * ai.js works out what it has not seen by subtracting its own cards and
     * everything on the table from a full deck, and a view gives it placeholder
     * cards with no fields for anything it may not see. Handing a bot a
     * projection would not throw — the hand would simply evaluate to nothing —
     * it would quietly make the computer play badly, which is the kind of bug
     * that gets diagnosed as "the AI feels off" for a month. */
    function pumpBots() {
