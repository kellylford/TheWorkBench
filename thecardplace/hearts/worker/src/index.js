/* Hearts - the Cloudflare edge of the room.
 *
 ...
 * nobody can play, so these are the ordinary rules of hearts rather than
 * anything clever. Four seats is not a default, it is the game. */
function defaultConfig() {
  /* Hearts is always four seats. There is no table size to choose and no
   * partnership to arrange, so this is shorter than its neighbours by the
   * amount hearts genuinely has less of — not by an oversight. */
  return {
    numPlayers: 4,
